...
<head>
   ...
   <div class="row">
	  ...
	  if(c!=null)
	  {
		  ...
		  RequestDispatcher rd=request.getRequestDispatcher("/custdashboard.jsp");
	  ...
	  %>
		 ...
		 <!-- form starts here -->
		 <form class="form-container" method="post" action="${pageContext.request.contextPath}/SaveCust" id="register_form">
		<center> <h1 style="color:white"><b>Sign In</b></h1></center>
		 ...
		 <div class="form-group">
			...
			<input type="password" class ="form-control input-box" name="password" placeholder="Password" id="myInput" required>
		 ...
		 <button type="submit" value="Submit" class="btn btn-success btn-block" onclick="sweetalert()">Submit</button>	
		  <a href="index.jsp" class="btn btn-default btn-block m-t-md">Back</a>
                                    ...
                                    <p class="text-center m-t-xs text-sm" style="color:white">Don't have an account?</p>
                                    <a href="register.jsp" class="btn btn-default btn-block m-t-md">Create an account</a>
